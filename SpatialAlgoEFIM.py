...
class SpatialAlgoEFIM:
    ...
    def runAlgorithm(self, minUtil):
        ...
        o.close()
        dataset = Dataset(self.inputPath, self.Neighbours)
        ...
        itemsToKeep = []
        # print('printing the pmus of each item')
        for key in self.utilityBinArrayLU.keys():
            # print(key, self.utilityBinArrayLU[key])
    ...
    def printStats(self):
        ...
        # print('High utility items are', self.highUtilityItemsets)
